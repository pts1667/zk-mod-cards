...
local options = {
  ...
  },
  {
    key    = 'carddraft',
    name   = 'Card Draft',
    desc   = 'Card draft timing and weighting settings.',
    type   = 'section',
  },
  {
    key    = 'zk_cards_first_draft_seconds',
    name   = 'First Card Draft Time',
    desc   = 'Time in seconds for the first card draft.',
    type   = 'number',
    section= 'carddraft',
    def    = 60,
    min    = 0,
  ...
  {
    key    = 'zk_cards_second_draft_seconds',
    name   = 'Second Card Draft Time',
    desc   = 'Time in seconds for the second card draft.',
    type   = 'number',
    section= 'carddraft',
    def    = 300,
    min    = 0,
  ...
  {
    key    = 'zk_cards_third_draft_seconds',
    name   = 'Third Card Draft Time',
    desc   = 'Time in seconds for the third card draft.',
    type   = 'number',
    section= 'carddraft',
    def    = 600,
    min    = 0,
  ...
  {
    key    = 'zk_cards_repeat_draft_interval_seconds',
    name   = 'Repeat Card Draft Interval',
    desc   = 'Time in seconds between recurring card drafts after the third one.',
    type   = 'number',
    section= 'carddraft',
    def    = 600,
    min    = 1,
  ...
  {
    key    = 'zk_cards_offers_per_draft',
    name   = 'Offers Per Draft',
    desc   = 'How many card offers each draft presents.',
    type   = 'number',
    section= 'carddraft',
    def    = 3,
    min    = 1,
  ...
  {
    key    = 'zk_cards_neutral_weight',
    name   = 'Neutral Card Weight',
    desc   = 'Relative chance of a neutral card draft.',
    type   = 'number',
    section= 'carddraft',
    def    = 1,
    min    = 0,
  ...
  {
    key    = 'zk_cards_good_weight',
    name   = 'Good Card Weight',
    desc   = 'Relative chance of a good card draft.',
    type   = 'number',
    section= 'carddraft',
    def    = 1,
    min    = 0,
  ...
  {
    key    = 'zk_cards_bad_weight',
    name   = 'Bad Card Weight',
    desc   = 'Relative chance of a bad card draft.',
    type   = 'number',
    section= 'carddraft',
    def    = 1,
    min    = 0,
